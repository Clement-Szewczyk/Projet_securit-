function verif_2(){
    ...
    if(rep2.checked==true && rep1.checked==false && rep3.checked==false && rep4.checked==false && rep5.checked==true && rep6.checked==false && rep7.checked==true && rep8.checked==true && rep9.checked==true && rep10.checked==true && rep11.checked==false && rep12.checked==true && rep13.checked==true && rep14.checked==true){
    ...
    //si pas de réponse
    if(rep1.checked==false && rep2.checked==false && rep3.checked==false && rep4.checked==false && rep5.checked==false && rep6.checked==false && rep7.checked==false && rep8.checked==false && rep9.checked==false && rep10.checked==false && rep11.checked==false && rep12.checked==false && rep13.checked==false && rep14.checked==false ){
